...
\begin{algorithmic}[1] %MS: the first LUB is  not necessary and would destroy narrwoing in a real world situation
\Procedure{Visit}{Terminator}%\Comment{T: syntax tree}
\State $\mathcal{N}_{BB} \gets \mathcal{D}_{BB} \,{\color{red}\sqcup}\, \mathcal{N}_{BB}$\Comment {\color{red}red: delegated to abstract domain\color{black}}
