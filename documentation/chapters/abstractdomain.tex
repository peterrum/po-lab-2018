...
\end{flalign*}
{\setlength{\abovedisplayskip}{-8pt}\begin{flalign*}
\quad & \overline{a} = \overline{b} \rightarrow s = 0 & \\
\quad \land\ & \overline{b} \in \gamma_N(s[\overline{a}, \overline{b}]_N) & \\
\quad \land\; & \overline{a} = \min\{a' \in \{0 \ldots 2^N-1\} \ldotp \gamma_N(s[\overline{a'}, \overline{b}]_N) = \gamma_N(s[\overline{a}, \overline{b}]_N)\} + 2^N \mathbb{Z} &
\end{flalign*}}
{\setlength{\abovedisplayskip}{-14pt}\begin{flalign*}
& ) &
\end{flalign*}}
\end{frame}
